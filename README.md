...
The first request copies the starter content from `data/data.json` into Blob. Later edits create persistent JSON versions in the connected store. Production and preview deployments use separate data prefixes.
