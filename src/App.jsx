...
const messages = {
  en: {
    ...
    storageError: 'Vercel storage is not connected. In the Vercel dashboard, create a public Blob store, connect it to this project, and redeploy.',
    all: 'All',
    phin: 'Phin',
    espresso: 'Espresso',
    signature: 'Signature',
  ...
  km: {
    ...
    storageError: 'មិនទាន់បានភ្ជាប់កន្លែងរក្សាទុក Vercel ទេ។ ក្នុង Vercel Dashboard សូមបង្កើត Public Blob Store ភ្ជាប់វាទៅ Project នេះ ហើយ Deploy ម្តងទៀត។',
    all: 'ទាំងអស់',
    phin: 'កាហ្វេហ្វីន',
